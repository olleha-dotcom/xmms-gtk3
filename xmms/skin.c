...
{
	skinpixmap->def_pixmap = gdk_pixmap_create_from_xpm_d(gtk_widget_get_window(mainwin), NULL, NULL, skindata);
...
static void skin_numbers_generate_dash(SkinPixmap *numbers)
{
	...
	pixmap = gdk_pixmap_new(gtk_widget_get_window(mainwin), 108,
